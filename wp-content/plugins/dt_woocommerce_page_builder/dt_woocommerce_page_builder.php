...
Description: is the ideal Visual Composer add-on to effortlessly layout a custom product page, custom cart page, custom checkout page, custom my account page for WooCommerce and more.
Version: 2.0.4
Author: DawnThemes 
...
if ( ! defined( 'DT_WOO_PAGE_BUILDER_VERSION' ) ) {
	 ...
	 *
	 */
	define( 'DT_WOO_PAGE_BUILDER_VERSION', '2.0.4' );
}
...
class DTWPB_Manager{
	...
	public function filter_wc_get_template($located, $template_name, $args, $template_path, $default_path){
		if( isset($args['woocommerce-page-builder-custom-templates']) ){
