...
<script type="text/javascript">
    jQuery(function($){
        ...
        $('document').ready(function () {
            ...
            populateRecipes('<?php echo $slug ?>');
            activeCategory('<?php echo $slug ?>');
            add_dropdown_class();
        ...
        function activeCategory(category){
            $("button[data-category='"+category+"']").parent().addClass('active');
            $('.recipelistoption').html($("button[data-category='"+category+"']").html());
        }
        ...
        function populateRecipes(category) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (len > 0) {
                        for (i = 0; i < len; i++) {
                            data[i].spice = data[i].spice ? data[i].spice : 1;
                            data[i].spicy = data[i].spicy ? data[i].spicy : "Mildly Spicy";
                            ...
                            txt += '<div class="recipeBlock">'+
                                ...
                                '</div></div>'+
                                '<div class="recipeMetaList"><div class="recipeMetaIcon">'+
                                '<i class="spriteSpicy-sm spicy'+data[i].spice+'"></i></div>'+
                                '<div class="recipeMetaText">'+data[i].spicy+'</div></div>'+
                                '</div></div></div>'+
