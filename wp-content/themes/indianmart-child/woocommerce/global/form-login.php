...
<form class="woocomerce-form woocommerce-form-login login" method="post" <?php echo ( $hidden ) ? 'style="display:none;"' : ''; ?>>
    ...
    <div class="col-xs-12 no-padding loginFormAction">
    ...
    <div class="col-sm-6 col-xs-12 no-padding">
        ...
        <label for="rememberme" class="checkboxText woocommerce-form__label woocommerce-form__label-for-checkbox inline"><?php _e( 'Remember me', 'woocommerce' ); ?></label>
    </div>
	<div class="lost_password col-sm-6 col-xs-12 text-right no-padding">
