...
if ( $terms_page_id > 0 && apply_filters( 'woocommerce_checkout_show_terms', true ) ) :
	...
	<div class="form-row terms wc-terms-and-conditions">
        ...
        <label for="terms" class="checkboxText woocommerce-form__label woocommerce-form__label-for-checkbox checkbox inline"><?php printf( __( 'I&rsquo;ve read and accept the <a href="%s" class="woocommerce-terms-and-conditions-link">terms &amp; conditions</a>', 'woocommerce' ), esc_url( wc_get_page_permalink( 'terms' ) ) ); ?><span class="required">*</span></label>
    </div>
    <div class="clear"></div>
