...
do_action( 'woocommerce_email_header', $email_heading, $email ); ?>
    ...
    <tr>
        ...
        <?php
            if ( $partial_refund ) {
                echo 'Your order on has been <span style="display: block;color:#ed5b30;text-align:center;font-weight: 600;">partially refunded</span>.';
            } else {
                echo 'Your order on has been <span style="display: block;color:#ed5b30;text-align:center;font-weight: 600;">refunded</span>.';
            }
        ?>
        </td>
    </tr>
