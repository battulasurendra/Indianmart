 ...
 do_action( 'woocommerce_email_header', $email_heading, $email ); ?>
    <tr>
        <td style="font-family: 'Open Sans', sans-serif;font-weight: 600; font-size:17px;line-height:24px;color:#000000; padding-top: 40px; padding-right: 10px;padding-bottom: 15px;padding-left: 10px;" align="center" width="470px">
            You have received <span style="display: block;color:#ed5b30;text-align:center;font-weight: 600;">new order</span> from <span style="display: block;color:#ed5b30;text-align:center;font-weight: 600;"><?php echo $order->get_formatted_billing_full_name(); ?></span>.
        </td>
    </tr>
    <tr>
