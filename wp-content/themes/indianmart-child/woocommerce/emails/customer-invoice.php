...
<?php if ( $order->has_status( 'pending' ) ) : ?>
    ...
    <tr>
        <td style="font-family: 'Open Sans', sans-serif;font-weight: 600; font-size:17px;line-height:24px;color:#000000; padding-top: 40px; padding-right: 10px;padding-bottom: 15px;padding-left: 10px;" align="center" width="470px">
            Your order has been created successfully on Indianmart. To pay for this order please use the following link:
            <br>
            <a href="<?php echo esc_url( $order->get_checkout_payment_url() ); ?>" style="display: block;color:#ed5b30;text-align:center;text-decoration: underline;font-weight: 600;">
                Make Payment
            </a>
        </td>
    </tr>
